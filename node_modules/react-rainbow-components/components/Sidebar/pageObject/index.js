...
function () {
  ...
  (0, _createClass2["default"])(PageSidebar, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-sidebar-item');

      if (items[itemPosition]) {
        return new PageSidebarItem("".concat(this.rootElement, " .rainbow-sidebar-item:nth-child(").concat(itemPosition + 1, ")"));
      }
