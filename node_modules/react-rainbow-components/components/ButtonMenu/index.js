...
function ButtonMenu(props) {
  var icon = props.icon,
      ...
      rest = (0, _objectWithoutProperties2["default"])(props, ["icon", "buttonSize", "title", "assistiveText", "buttonVariant", "buttonShaded", "disabled", "tabIndex", "onFocus", "onBlur", "children"]);
...
ButtonMenu.propTypes = {
  ...
  buttonVariant: _propTypes["default"].oneOf(['base', 'brand', 'success', 'border', 'border-filled', 'border-inverse', 'inverse']),
