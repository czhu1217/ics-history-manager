...
function (_Component) {
  ...
  (0, _createClass2["default"])(Input, [{
    ...
    value: function getContainerClassNames() {
      ...
      return (0, _classnames2["default"])('rainbow-date-picker_input-container', {
    ...
    value: function getIconPositionClassNames() {
      ...
      }, "rainbow-date-picker_input-icon--".concat(iconPosition), icon));
    }
  }, {
    ...
    value: function getInputClassNames() {
      ...
      return (0, _classnames2["default"])('rainbow-date-picker_input', {
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        className: "rainbow-date-picker_input-error"
      }, error)));
    }
  }]);
  return Input;
