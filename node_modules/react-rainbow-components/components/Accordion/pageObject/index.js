...
function () {
  ...
  (0, _createClass2["default"])(PageAccordion, [{
    ...
    value: function getItem(itemPosition) {
      var items = $(this.rootElement).$$('.rainbow-accordion-section_container');

      if (items[itemPosition]) {
        return new PageAccordionSection("".concat(this.rootElement, " .rainbow-accordion-section_container:nth-child(").concat(itemPosition + 1, ")"));
      }
