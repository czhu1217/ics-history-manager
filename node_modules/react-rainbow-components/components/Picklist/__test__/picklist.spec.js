...
describe('<Picklist />', function () {
  ...
  it('should remove child from list when it is selected', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_.Component, {
      label: "Picklist"
    }, _react["default"].createElement(_PicklistOption["default"], {
      label: "Option 1",
    ...
    jest.runAllTimers();
    var itemIndex = component.instance().activeChildren.findIndex(function (child) {
      return child.name === 'option1';
    });
  ...
  it('should open menu when click the picklist input', function () {
    ...
    expect(component.find("div[role='presentation']").prop('className')).toBe('rainbow-picklist');
    component.instance().menuRef.current = menuRef;
    component.find('input').simulate('click');
    expect(component.state().isOpen).toBe(true);
    expect(component.find("div[role='presentation']").prop('className')).toBe('rainbow-picklist rainbow-picklist--open');
  });
  ...
  it('should fire onChange when option is selected by click', function () {
    ...
    component.instance().openMenu();
    component.update();
    component.find('li.rainbow-picklist-option').at(1).simulate('mousedown');
  ...
  it('should fire onChange when option is selected by pressing ENTER key', function () {
    ...
    component.instance().openMenu();
    component.update();
    component.find('li.rainbow-picklist-option').at(1).simulate('keyDown', {
