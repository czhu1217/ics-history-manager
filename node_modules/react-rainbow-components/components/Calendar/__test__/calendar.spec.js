...
describe('Calendar', function () {
  ...
  it('should render a day selected when value passed is a date', function () {
    var value = new Date('04/24/2019');
    var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
      value: value
    }));
    expect(component.find('button[className="rainbow-calendar_day-button rainbow-calendar_day-button--selected"]').exists()).toBe(true);
  });
  it('should not render a day selected when pass falsy values', function () {
    var values = ['', undefined, null, 0];
    values.forEach(function (value) {
      var component = (0, _enzyme.mount)(_react["default"].createElement(_["default"], {
        value: value
      }));
      expect(component.find('button[className="rainbow-calendar_day-button rainbow-calendar_day-button--selected"]').exists()).toBe(false);
    });
  });
});